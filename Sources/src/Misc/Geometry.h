...
public:
  union
  {
    ...
    struct { float a, b, c; };						// 'd' is the one above
		struct { CVec4 vec4; };
  };
public:
  SPlane() {  }
	// 'a', 'b', 'c' and 'd' live in different arms of the union, so they are
	// assigned in the body rather than in the initialiser list
